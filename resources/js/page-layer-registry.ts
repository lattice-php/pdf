...
export const PDF_PAGE_LAYER_EXTENSION = "pdf.page-layer";
...
export function usePdfPageLayerRegistry(): PdfPageLayerRegistry {
  return useExtensionRegistry<PdfPageLayerRegistry>(PDF_PAGE_LAYER_EXTENSION);
}
